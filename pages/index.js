    ...
    <Layout title="Home">
      {status === 'loading' ? (
        ...
        <div className="m-auto mx-0 mt-0">
          <div className="flex flex-col-reverse justify-end h-screen sm:pt-32 lg:pt-40 sm:justify-center jio bg-primary sm:flex-row">
            <div className="px-2 sm:px-5">
              <h1 className="text-4xl font-bold jioT sm:text-5xl xl:text-7xl">
                Discover Events
              </h1>
              <h2 className="text-3xl font-bold sm:text-5xl xl:text-7xl text-secondary">
                around You !
              </h2>
              ...
              <div className="flex items-center justify-center jioLink">
          ...
          <div className="flex flex-col items-center justify-start sm:justify-center sm:flex-row">
            ...
            <div className="px-3 mb-5">
              <h1 className="text-4xl font-bold sm:text-5xl xl:text-7xl text-textPrimary ">
                Get paid instantly
              </h1>
